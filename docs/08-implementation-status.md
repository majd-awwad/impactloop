...
| `learning-projects`            | **Implemented** | Public read list + detail (`PUBLISHED` only) with project like/follower counts, rating summaries, recent reviews, and viewer liked/saved/followed/review state; learner like/unlike/save/unsave/follow/unfollow/review; learner `POST /submit` → `PENDING_REVIEW`; admin moderation module                                                       |
...
| `learning_hub`       | **Partial**                  | `GET /api/learning-projects`; `GET /api/learning-projects/me/saved`; `GET /api/learning-projects/me/followed`; categories; `POST/DELETE /api/learning-projects/:id/like`; `POST/DELETE /api/learning-projects/:id/save`; `POST/DELETE /api/learning-projects/:id/follow`; `PUT/DELETE /api/learning-projects/:id/review`; `POST /api/learning-projects/submit`; `/api/admin/learning-projects/*` moderation | List/detail + Home spotlight API-backed; saved/followed learner tabs; add-draft submits for review; learner project likes/saves/follows use in-card/detail controls; reviews on detail; local build checklist + component material-search handoff; material detail project-search handoff; admin moderation at `/admin/learning-projects`; AI disabled                                  | [learning-hub.md](features/learning-hub.md)           |
...
| Learning hub API → Flutter                   | **Partial**         | Read path wired: `/learning`, `/learning/:id`, Home spotlight; add-draft submission, project likes/saves/follows/reviews, saved/followed learner listing tabs, local build checklist, component material-search handoff, material detail project-search handoff, and admin moderation wired; server-side page navigation exposed; AI/persisted checklist/material linking pending                                                                       |
...
| Learning projects                     | Yes       | Yes (PUBLISHED only + learner submit + admin moderation + learner engagement/reviews) | **Partial** — browse/detail/spotlight API-backed; add-draft submits for admin review; learner likes/saves/follows/reviews; admin moderation UI exists |
| Reviews                               | Yes       | No                                                       | No                                                                                                               |
