...
| Learning hub API → Flutter                   | **Partial**         | Read path wired: `/learning`, `/learning/:id`, Home spotlight; add-draft submission, project likes/saves/follows/reviews, saved/followed learner listing tabs, persisted build checklist with material link/unlink and reservation-aware linking, supplier dashboard project-linked impact summary (`projectSupport`), component material-search handoff, material detail project-search handoff, and admin moderation wired; server-side page navigation exposed; AI matching and auto-reservation without learner action pending |
