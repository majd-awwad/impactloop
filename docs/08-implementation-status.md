...
| 5 Learning hub + AI  | Projects + AI matching           | **Partial** — read API wired (Hub list/detail + Home spotlight); add-draft submission, admin moderation, learner project likes/saves/follows/reviews, saved/followed learner listing tabs, local build checklist, component material-search handoff, material detail project-search handoff, and server-side Learning Hub page navigation wired; AI/persisted checklist/material linking **not implemented** |
...
| Learning hub           | [features/learning-hub.md](features/learning-hub.md)                     | [flows/learning-hub-browse-flow.md](flows/learning-hub-browse-flow.md)                                                                                       | **Partial** — read path API-backed; add-draft submit, admin moderation, learner project likes/saves/follows/reviews, saved/followed learner listing tabs, local build checklist, component material-search handoff, material detail project-search handoff, and server-side page navigation wired; AI/persisted checklist/material linking pending |


**Not covered as implemented:** AI agent, moderator portal, persisted build checklist, realtime driver tracking stream, scheduled background reservation expiry cron, and QR polish remain pending/deferred.
