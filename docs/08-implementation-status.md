...
| `learning_hub`       | **Partial**                  | `GET /api/learning-projects`; `GET /api/learning-projects/me/saved`; `GET /api/learning-projects/me/followed`; categories; `POST/DELETE /api/learning-projects/:id/like`; `POST/DELETE /api/learning-projects/:id/save`; `POST/DELETE /api/learning-projects/:id/follow`; `PUT/DELETE /api/learning-projects/:id/review`; `GET/POST/PATCH /api/learning-projects/:id/builds*`; `POST /api/learning-projects/submit`; `/api/admin/learning-projects/*` moderation + component enrichment | List/detail + Home spotlight API-backed; saved/followed learner tabs; add-draft submits for review; learner project likes/saves/follows use in-card/detail controls; reviews on detail; persisted manual build checklist + component material-search handoff; material detail project-search handoff; admin moderation at `/admin/learning-projects` with component quality warnings and single-component edit before publish; AI disabled                                  | [learning-hub.md](features/learning-hub.md)           |
...
| Learning hub API → Flutter                   | **Partial**         | Read path wired: `/learning`, `/learning/:id`, Home spotlight; structured add-draft component cards + submit API alignment, project likes/saves/follows/reviews, saved/followed learner listing tabs, persisted build checklist with material link/unlink and reservation-aware linking, supplier dashboard project-linked impact summary (`projectSupport`), component material-search handoff, material detail project-search handoff, and admin moderation wired; server-side page navigation exposed; AI matching and auto-reservation without learner action pending |
...
| 5 Learning hub + AI  | Projects + AI matching           | **Partial** — read API wired (Hub list/detail + Home spotlight); add-draft submission with structured components, admin moderation, learner project likes/saves/follows/reviews, saved/followed learner listing tabs, persisted build checklist, ranked material candidates (relevance/convenience/cost), material linking, reservation-aware build linking, component material-search handoff, material detail project-search handoff, and server-side Learning Hub page navigation wired; **AI matching not implemented** |
...
| Learning hub           | [features/learning-hub.md](features/learning-hub.md)                     | [flows/learning-hub-browse-flow.md](flows/learning-hub-browse-flow.md)                                                                                       | **Partial** — read path API-backed; add-draft submit with structured components, admin moderation, learner project likes/saves/follows/reviews, saved/followed learner listing tabs, persisted build checklist, ranked material candidates, material linking, reservation-aware build linking, component material-search handoff, material detail project-search handoff, and server-side page navigation wired; AI matching pending |
