...
**Purpose:** Public read API for learning hub projects (list + detail), learner project likes/saves/follows, and learner project submit-for-review.
...
**Prisma:** `LearningProject`, `ProjectLike`, `ProjectSave`, `ProjectFollow`, and related project tables
