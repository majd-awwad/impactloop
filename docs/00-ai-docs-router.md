...
| Delivery | [features/delivery.md](features/delivery.md) | [flows/delivery-flow.md](flows/delivery-flow.md) | **Partial** — learner request/status UI and driver jobs/status UI; live tracking UI not implemented |
