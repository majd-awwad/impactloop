...
**Not documented as implemented:** live realtime tracking stream, AI material matching agent, moderator portal, saved/followed-project listing, project build checklist, and moderator-owned project review workflow.
