...
Coverage must therefore be read as both 159/159 for the comparable seeded set and 199/199 for the current local database. Historical Phase 2B component-role coverage evidence is preserved in [`phase-2b-validation.md`](../archive/recommendation-history/phase-2b-validation.md) (historical validation report, not current runtime architecture).
