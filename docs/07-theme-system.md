...
| Learning tokens | `app_color_tokens.dart`, `features/learning_hub/data/learning_hub_mock_data.dart` | Learning hub color data exists, but learning UI remains mock-data oriented. |
