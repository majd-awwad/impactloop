...
void main() {
  group('LearningSpotlightSection', () {
    ...
    testWidgets('shows compact engagement controls on project cards', (
      ...
      final engagementStrip = find.byType(ProjectEngagementStrip);
      expect(
        find.descendant(of: engagementStrip, matching: find.text('7')),
        findsOneWidget,
      );
      expect(find.byTooltip('Remove saved project'), findsOneWidget);
      expect(
        find.descendant(of: engagementStrip, matching: find.text('3')),
        findsOneWidget,
      );
