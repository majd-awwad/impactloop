...
void main() {
  test('detail contract preserves canonical actions and conditional context', () {
  ...
  test('unknown backend classifiers remain non-executable', () {
    ...
    expect(detail.reservation.workflowPhase?.value, SupplierWorkflowPhase.unknown);
    expect(detail.reservation.attentionState?.value, SupplierAttentionState.unknown);
