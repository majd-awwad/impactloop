                ...
                children: [
                  ...
                  if (hasMoreProjects) ...[
                    ...
                    Align(
                      ...
                      child: OutlinedButton.icon(
                        onPressed: () {
                          setState(() {
                            _visibleProjectCount = (_visibleProjectCount + _chunkSize)
                                .clamp(0, projects.length);
                          });
                        },
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: learningHintSurface,
                      borderRadius: BorderRadius.circular(22),
                      border: Border.all(color: learningHintBorder),
                    ),
                    child: Row(
                      children: [
                        const Icon(
                          ...
                          child: RichText(
                            ...
                            text: TextSpan(
                              ...
                              children: [
                                ...
                                TextSpan(
                                  text: learningFeaturedTip.resolve(context),
                                ),
                              ],
                            ),
                          ),
