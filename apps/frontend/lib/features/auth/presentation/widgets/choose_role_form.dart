...
class ChooseRoleForm extends ConsumerStatefulWidget {
  const ChooseRoleForm({super.key});

  @override
  ConsumerState<ChooseRoleForm> createState() => _ChooseRoleFormState();
}

class _ChooseRoleFormState extends ConsumerState<ChooseRoleForm> {
  ...
  Future<void> _handleContinue() async {
    ...
    ref.read(registrationDraftProvider.notifier).setIntent(intent);
