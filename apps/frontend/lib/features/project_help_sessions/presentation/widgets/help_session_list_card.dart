...
class HelpSessionListCard extends StatelessWidget {
  const HelpSessionListCard({super.key, required this.session});
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: InkWell(
        onTap: () => context.push(learnerHelpSessionDetailRoute(session.id)),
