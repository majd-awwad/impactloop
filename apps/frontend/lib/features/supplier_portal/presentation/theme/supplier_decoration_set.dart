...
class SupplierDecorationSet {
  ...
  LinearGradient get heroGradient => LinearGradient(
    ...
    colors: [colors.landingBackground, colors.surfaceSolid, colors.background],
    stops: const [0.0, 0.58, 1.0],
  );

  BoxDecoration get pageBackground =>
      BoxDecoration(color: colors.landingBackground);
  ...
  BoxDecoration get highlightedStatCard => BoxDecoration(
    color: colors.surfaceSolid,
    borderRadius: AppRadius.lgAll,
    border: Border.all(color: colors.borderFocused.withValues(alpha: 0.42)),
    boxShadow: [
      BoxShadow(
        color: colors.cardShadow.withValues(alpha: 0.10),
        blurRadius: 18,
  ...
  BoxDecoration navItem({required bool isActive}) => BoxDecoration(
    ...
    border: isActive
        ? Border.all(color: colors.borderFocused.withValues(alpha: 0.45))
        : null,
  );
  ...
  BoxDecoration get avatarCircle => BoxDecoration(
    ...
    border: Border.all(color: colors.borderFocused.withValues(alpha: 0.5)),
  );
  ...
  BoxDecoration get profileSectionPanel => BoxDecoration(
    color: colors.backgroundElevated.withValues(
