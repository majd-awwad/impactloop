...
class SupplierL10n {
  ...
  String get viewSupplierProfile =>
      t('View supplier profile', 'عرض ملف المورد');
  String get logout => t('Logout', 'تسجيل الخروج');

  // —— Page subtitles ——
  String get subtitleOverview => t(
  ...
  String get myMaterialsEmptyTitle =>
      t('You have not listed any materials yet.', 'لم تدرج أي مواد بعد.');
  ...
  String get myMaterialsLoadError =>
      t('We could not load your materials.', 'تعذّر تحميل موادك.');
  ...
  String get reuseHistorySectionTitle =>
      t('Reuse history', 'سجل إعادة الاستخدام');
  ...
  String get noDemandSignalsYet =>
      t('No demand signals yet.', 'لا توجد إشارات طلب بعد.');
  ...
  String get materialHasActiveDemand =>
      t('This material has active demand.', 'هذه المادة لديها طلب نشط.');
  ...
  String get noActiveDemandYet =>
      t('No active demand yet.', 'لا يوجد طلب نشط بعد.');
  ...
  String overallDemandScoreValue(int percent) => t('$percent%', '$percent%');
  ...
  String get markUnavailableAction => t('Mark unavailable', 'تعليم كغير متاحة');
  ...
  String get openReservationActionLabel => t('Open reservation', 'فتح الحجز');
  ...
  String get materialUpdatedSuccess =>
      t('Material updated successfully.', 'تم تحديث المادة بنجاح.');
  ...
  String get materialDeletedSuccess =>
      t('Material deleted successfully.', 'تم حذف المادة بنجاح.');
  ...
  String get editMaterialBlockedTitle =>
      t('Editing not available', 'التعديل غير متاح');
  ...
  String get editListingComingSoon =>
      t('Editing listings is coming soon.', 'تعديل الإدراجات قريباً.');
  ...
  String get backToMyMaterials => t('Back to My Materials', 'العودة إلى موادي');
  ...
  String get statReusedMaterials =>
      t('Reused materials', 'المواد المعاد استخدامها');
  ...
  String get statReservedMaterials =>
      t('Reserved materials', 'المواد المحجوزة');
  ...
  String get engagementTotalsLabel => t('Account totals', 'إجماليات الحساب');
  ...
  String viewsCountLabel(int count) => t('$count views', '$count مشاهدة');
  ...
  String get strongDemandInsight => t(
  ...
  String get actionableInsights =>
      t('Actionable insights', 'رؤى قابلة للتنفيذ');
  ...
  String get completeSupplierProfileTitle =>
      t('Complete your supplier profile', 'أكمل ملف المورد');
  ...
  String maxPriceLabel(double max, String unit) => t(
  ...
  String supplierNotificationActionLabel(
    ...
    return switch (actionType) {
      ...
      SupplierNotificationActionType.openReservation => t(
        'Open reservation',
        'فتح الحجز',
      ),
      SupplierNotificationActionType.choosePickupWindow => t(
      ...
      SupplierNotificationActionType.openMaterial => t(
        'Open material',
        'فتح المادة',
      ),
      SupplierNotificationActionType.openProfile => t(
        'Open profile',
        'فتح الملف الشخصي',
      ),
  ...
  String get heroChipSupplierActive => t('Supplier active', 'المورد نشط');
  String get heroChipPickupEnabled => t('Pickup enabled', 'الاستلام مفعّل');
  String get heroChipNisListings => t('NIS listings', 'إدراجات بالشيكل');
  ...
  String get materialsChartUnavailable => t('Unavailable', 'غير متاحة');
  ...
  String recentActivityAcceptedPickup(String name) =>
      t('Accepted pickup with $name', 'استلام مقبول مع $name');
  String get recentActivityLatestReuse =>
      t('Latest completed reuse', 'أحدث إعادة استخدام مكتملة');
  String get chooseSupplierType => t('Choose supplier type', 'اختر نوع المورد');
  String get dragPhotosHint =>
      t('Choose photos from your device', 'اختر الصور من جهازك');
  String get materialCouldNotBeListed =>
      t('Material could not be listed.', 'تعذّر إدراج المادة.');
  ...
  String get enterValidQuantityPrice =>
      t('Enter a valid quantity and price.', 'أدخل كمية وسعراً صالحين.');
  String get priceReviewRequestFailed =>
      t('Price review request failed.', 'فشل طلب مراجعة السعر.');
  ...
  String priceVerificationFailed(String error) =>
      t('Price verification failed: $error', 'فشل التحقق من السعر: $error');
  String get submitPriceReview =>
      t('Submit price review', 'إرسال مراجعة السعر');
  String get clarifyMaterialName =>
      t('Please clarify the material name', 'يرجى توضيح اسم المادة');
  String get didYouMeanThese =>
      t('Did you mean one of these?', 'هل تقصد أحد هذه؟');
  String matchedPriceReference(String label) =>
      t('Matched price reference: $label', 'مرجع السعر المطابق: $label');
  ...
  String get myMaterialsPopover => t('My materials', 'موادي');
  String get incomingRequestsPopover =>
      t('Incoming requests', 'الطلبات الواردة');
  String get statHelperVisibleToLearners =>
      t('Currently visible to learners', 'ظاهرة حالياً للمتعلمين');
  String get statHelperWaitingResponse =>
      t('Waiting for your response', 'بانتظار ردك');
  ...
  String pendingRequestsNeedResponse(int count) => t(
    ...
    count == 1 ? 'طلب واحد يحتاج ردك.' : '$count طلبات تحتاج ردك.',
  );
  String completedReservationsSummary(int count) => t(
    '$count reservation${count == 1 ? '' : 's'} completed successfully.',
    count == 1 ? 'اكتمل حجز واحد بنجاح.' : 'اكتمل $count حجوزات بنجاح.',
  );
  ...
  String get pickupCompleteFailed =>
      t('Could not mark pickup as completed.', 'تعذّر تحديد الاستلام كمكتمل.');
  ...
  String get tabExpired => t('Expired — no response', 'منتهٍ — لا رد');
  String get tabCompleted => filterCompleted;
  String get noRequests => t('No requests yet.', 'لا توجد طلبات بعد.');
  String get noRequestsForFilter =>
      t('No requests match this filter.', 'لا توجد طلبات تطابق هذا الفلتر.');
  ...
  String incomingRequestStatusLabel(SupplierIncomingRequestStatus status) =>
      switch (status) {
        ...
        SupplierIncomingRequestStatus.awaitingSupplierConfirmation => t(
  ...
  String get pickupScheduleLoadError =>
      t('We could not load pickup schedule.', 'تعذّر تحميل جدول الاستلام.');
  ...
  String get publicDetails =>
      t('Public supplier details', 'تفاصيل المورد العامة');
  ...
  String get aboutMaterialsHint => t(
    'Share the material types you usually offer.',
    'شارك أنواع المواد التي تقدمها عادة.',
  );
  String get defaultPickupArea =>
      t('Default pickup area', 'منطقة الاستلام الافتراضية');
  ...
  String get organizationDetails => t('Organization details', 'تفاصيل المؤسسة');
  ...
  String get profileUnavailable => t('Profile unavailable', 'الملف غير متاح');
  ...
  String get currentLocationLabel => t('Current location', 'الموقع الحالي');
  ...
  String get chooseVisibility => t('Choose visibility', 'اختر مستوى الظهور');
  String get workingDays => t('Working days', 'أيام العمل');
  String get workingDaysHint =>
      t('Mon, Tue, Wed', 'الإثنين، الثلاثاء، الأربعاء');
  ...
  String get countryOptionalLabel => t('Country (optional)', 'البلد (اختياري)');
  ...
  String get optionalNeighborhoodOrDistrict =>
      t('Optional neighborhood or district', 'الحي أو المنطقة (اختياري)');
  String get optionalStreetOrBuilding =>
      t('Optional street or building', 'الشارع أو المبنى (اختياري)');
  ...
  String get listingSectionTitle => t('What are you listing?', 'ماذا تدرج؟');
  ...
  String get noReviewedPrice => t('No reviewed price', 'لا يوجد سعر مراجع');
  ...
  String get suggestedUsesHint => t(
  ...
  String get categoryRequired => t('Category is required', 'الفئة مطلوبة');
  ...
  String get quantityAndPricing => t('Quantity and pricing', 'الكمية والتسعير');
  ...
  String get policyBadgePaidVerify =>
      t('Paid needs price verification', 'المدفوع يحتاج تحققاً من السعر');
  String get restoreDraftError =>
      t('Could not restore listing draft', 'تعذّر استعادة مسودة الإدراج');
  String get backToNotifications =>
      t('Back to Notifications', 'العودة للإشعارات');
  String get materialListedSuccess =>
      t('Material listed successfully.', 'تم إدراج المادة بنجاح.');
  String get addAnotherMaterial => t('Add another material', 'إضافة مادة أخرى');
  ...
  String sourceTypeLabel(String value) => switch (value) {
    ...
    'EDUCATIONAL_INSTITUTION' => t('Educational institution', 'مؤسسة تعليمية'),
    _ => value,
  };
  ...
  String supplierTypeLabel(String value) {
    ...
    return switch (normalized) {
      'INDIVIDUAL_SUPPLIER' ||
      'INDIVIDUAL' => t('Individual supplier', 'مورد فردي'),
  ...
  String get verificationAdminNoteLabel => t('Admin note', 'ملاحظة المسؤول');
  ...
  String locationVisibilityLabel(String visibility) =>
      t('Location visibility: $visibility', 'ظهور الموقع: $visibility');
  ...
  String get cancelReservationAction => t('Cancel reservation', 'إلغاء الحجز');
  ...
  String get followUpMessagesTitle => t('Follow-up messages', 'رسائل المتابعة');
  String get noFollowUpMessagesYet =>
      t('No follow-up messages yet.', 'لا توجد رسائل متابعة بعد.');
  String get followUpMessageHint =>
      t('Write a short follow-up message…', 'اكتب رسالة متابعة قصيرة…');
  String get messagesLoadFailed =>
      t('Could not load messages.', 'تعذر تحميل الرسائل.');
  String get messageSendFailed =>
      t('Could not send message.', 'تعذر إرسال الرسالة.');
  String get needsFollowUpBadge => t('Needs follow-up', 'يحتاج متابعة');
  String get overdueBadge => t('Overdue', 'متأخر');
  String get reschedulePickupTitle =>
      t('Reschedule pickup', 'إعادة جدولة الاستلام');
  String get cancelReservationTitle => t('Cancel reservation', 'إلغاء الحجز');
  ...
  String get reportNoShowTitle => t('Report no-show', 'الإبلاغ عن عدم حضور');
  ...
  String get confirmPickupWindowLabel => t('Pickup window', 'نافذة الاستلام');
  String get driverPickupWindowFromSupplier =>
      t('Driver pickup window from supplier', 'نافذة استلام السائق من المورد');
  ...
  String get pickupCustomWindowHint =>
      t('Custom proposed window', 'نافذة مقترحة مخصصة');
  String get learnerPreferredPickupWindows =>
      t('Learner preferred pickup windows', 'نوافذ الاستلام المفضلة للمتعلم');
  String get learnerPreferredDeliveryWindows =>
      t('Learner preferred delivery windows', 'نوافذ التوصيل المفضلة للمتعلم');
  ...
  String get proposeCustomDeliveryWindow =>
      t('Propose custom delivery window', 'اقتراح نافذة توصيل مخصصة');
  String get customDeliveryWindowLabel =>
      t('Proposed learner delivery window', 'نافذة التوصيل المقترحة للمتعلم');
  ...
  String get requestAwaitingConfirmation => t(
  ...
  String get verifyPriceBeforePublishing =>
      t('Verify price before publishing', 'تحقق من السعر قبل النشر');
  String get priceVerificationRequired =>
      t('Price verification required', 'التحقق من السعر مطلوب');
  ...
  String approvedAs(String name) =>
      t('Approved as $name', 'موافق عليه كـ $name');
  String get waitingAdminApproval =>
      t('Waiting for admin approval.', 'بانتظار موافقة المسؤول.');
  ...
  String get locationCapturedShort => t('Location captured', 'تم تحديد الموقع');
  ...
  String get organizationProfile => t('Organization profile', 'ملف المؤسسة');
  String get supplierProfileLabel => t('Supplier profile', 'ملف المورد');
  String get pickupNoteHint => t(
    'Ring the workshop bell when you arrive.',
    'اضغط جرس الورشة عند وصولك.',
  );
  String get declineReasonHint =>
      t('Already reserved for another learner.', 'محجوز لمُتعلم آخر.');
  String get materialListingFoundationReady =>
      t('Material listing foundation ready', 'أساس إدراج المواد جاهز');
  String materialCategoriesLoaded(int count) =>
      t('$count material categories loaded.', 'تم تحميل $count فئات مواد.');
  String get loadingCategories =>
      t('Loading categories...', 'جاري تحميل الفئات...');
  String get categoriesCouldNotLoad =>
      t('Categories could not be loaded yet.', 'تعذّر تحميل الفئات بعد.');
  ...
  String get pickupPinSelectedOnMap =>
      t('Pickup pin selected on map', 'تم تحديد دبوس الاستلام على الخريطة');
  ...
  String get pickupWindowSectionTitle => t('Pickup window', 'نافذة الاستلام');
  ...
  String get pickupInstructionsLabel => t('Instructions', 'التعليمات');
  String get noPickupInstructions =>
      t('No pickup instructions.', 'لا توجد تعليمات استلام.');
  String get noDeclineReasonProvided =>
      t('No decline reason provided.', 'لم يُقدَّم سبب للرفض.');
