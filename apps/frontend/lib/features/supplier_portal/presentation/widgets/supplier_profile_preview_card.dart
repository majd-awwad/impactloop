    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Icon(Icons.visibility_outlined, color: AuthDarkColors.accent),
    ...
    return Container(
      ...
      child: const Row(
        ...
        children: [
          ...
          Icon(Icons.handyman_outlined, color: AuthDarkColors.accentMuted, size: 16),
          Icon(Icons.inventory_2_outlined, color: AuthDarkColors.textSecondary, size: 16),
        ],
      ),
    );
  }
