...
class AdminDecorationSet {
  ...
  BoxDecoration get pageBackground =>
      BoxDecoration(color: palette.pageBackground);
  ...
  BoxDecoration navItem({required bool isActive}) => BoxDecoration(
    ...
    border: isActive
        ? Border.all(color: palette.sidebarActiveAccent.withValues(alpha: 0.45))
        : null,
  );
  ...
  BoxDecoration get sidebarProfile => BoxDecoration(
    ...
    border: Border.all(color: palette.sidebarBorder.withValues(alpha: 0.85)),
  );
