...
const PURE = [
  ...
  'src/modules/recommendations/ml-lightfm-scorer.test.ts',
  ...
  'src/modules/taxonomy/component-concept-assignment.test.ts',
  'src/modules/taxonomy/component-taxonomy-audit.test.ts',
  ...
  'src/modules/taxonomy/taxonomy-compatibility-relations.test.ts',
...
const DB = [
  ...
  'src/modules/taxonomy/taxonomy-compatibility-relations.seed.integration.test.ts',
  'src/modules/taxonomy/taxonomy-concept-relation.test.ts',
