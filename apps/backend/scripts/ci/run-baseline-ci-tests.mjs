...
const DB = [
  ...
  'src/modules/delivery-handover-credentials/delivery-handover-credentials.test.ts',
  'src/modules/supplier-pickup-handover-credentials/supplier-pickup-handover-credentials.test.ts',
  ...
  'src/modules/driver/driver-history.schema.integration.test.ts',
];
