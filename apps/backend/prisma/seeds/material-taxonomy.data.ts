...
export const MATERIAL_CATEGORY_SEEDS = [
  ...
  { nameEn: 'Household Reusables', nameAr: 'أدوات منزلية قابلة لإعادة الاستخدام' },
...
export const MATERIAL_TYPE_SEEDS: Record<string, MaterialTypeSeed[]> = {
  Electronics: [
    {
      ...
      priceRule: { unit: 'piece', maxAllowedUnitPriceNis: 70, maxAllowedTotalPriceNis: 160 },
    },
    {
      nameEn: 'Raspberry Pi',
      nameAr: 'Raspberry Pi',
      ...
      priceRule: { unit: 'piece', maxAllowedUnitPriceNis: 250, maxAllowedTotalPriceNis: 550 },
    },
    {
      ...
      priceRule: { unit: 'piece', maxAllowedUnitPriceNis: 15, maxAllowedTotalPriceNis: 40 },
    },
    {
      nameEn: 'Jumper Wires',
      nameAr: 'أسلاك توصيل',
      ...
      priceRule: { unit: 'pack', maxAllowedUnitPriceNis: 12, maxAllowedTotalPriceNis: 30 },
    },
    {
      nameEn: 'Breadboard',
      nameAr: 'لوحة تجارب',
      ...
      priceRule: { unit: 'piece', maxAllowedUnitPriceNis: 18, maxAllowedTotalPriceNis: 45 },
    },
    {
      nameEn: 'DC Motor',
      nameAr: 'محرك DC',
      ...
      priceRule: { unit: 'piece', maxAllowedUnitPriceNis: 20, maxAllowedTotalPriceNis: 50 },
    },
    {
      nameEn: 'Servo Motor',
      nameAr: 'سيرفو موتور',
      ...
      priceRule: { unit: 'piece', maxAllowedUnitPriceNis: 35, maxAllowedTotalPriceNis: 80 },
    },
    {
      nameEn: 'Motor Driver',
      nameAr: 'درايفر محرك',
    ...
    },
    {
      ...
      priceRule: { unit: 'meter', maxAllowedUnitPriceNis: 8, maxAllowedTotalPriceNis: 80 },
    },
    {
      ...
      priceRule: { unit: 'pack', maxAllowedUnitPriceNis: 10, maxAllowedTotalPriceNis: 25 },
    },
  ],
  'Art, Craft & Molding': [
    {
      ...
      priceRule: { unit: 'piece', maxAllowedUnitPriceNis: 30, maxAllowedTotalPriceNis: 90 },
    },
    {
      ...
      priceRule: { unit: 'piece', maxAllowedUnitPriceNis: 35, maxAllowedTotalPriceNis: 110 },
    },
    {
      nameEn: 'Resin Molds',
      nameAr: 'قوالب ريزين',
      ...
      priceRule: { unit: 'piece', maxAllowedUnitPriceNis: 32, maxAllowedTotalPriceNis: 100 },
    },
    {
      ...
      priceRule: { unit: 'set', maxAllowedUnitPriceNis: 25, maxAllowedTotalPriceNis: 90 },
    },
    {
      nameEn: 'Craft Tools',
      nameAr: 'أدوات حرف',
      ...
      priceRule: { unit: 'set', maxAllowedUnitPriceNis: 30, maxAllowedTotalPriceNis: 100 },
    },
  ],
  'Wood & Timber': [
    {
      ...
      priceRule: { unit: 'piece', maxAllowedUnitPriceNis: 25, maxAllowedTotalPriceNis: 120 },
    },
    {
      nameEn: 'Wood Scraps',
      nameAr: 'بقايا خشب',
      ...
      priceRule: { unit: 'kg', maxAllowedUnitPriceNis: 5, maxAllowedTotalPriceNis: 40 },
    },
    {
      ...
      priceRule: { unit: 'piece', maxAllowedUnitPriceNis: 35, maxAllowedTotalPriceNis: 140 },
    },
  ],
  'Plastic & Acrylic': [
    {
      ...
      priceRule: { unit: 'piece', maxAllowedUnitPriceNis: 30, maxAllowedTotalPriceNis: 120 },
    },
    {
      ...
      priceRule: { unit: 'piece', maxAllowedUnitPriceNis: 18, maxAllowedTotalPriceNis: 70 },
    },
    {
      ...
      priceRule: { unit: 'piece', maxAllowedUnitPriceNis: 8, maxAllowedTotalPriceNis: 40 },
    },
  ],
  'Fabric & Textile': [
    {
      ...
      priceRule: { unit: 'kg', maxAllowedUnitPriceNis: 6, maxAllowedTotalPriceNis: 35 },
    },
    {
      nameEn: 'Yarn',
      nameAr: 'خيوط صوف',
      ...
      priceRule: { unit: 'pack', maxAllowedUnitPriceNis: 12, maxAllowedTotalPriceNis: 40 },
    },
    {
      ...
      priceRule: { unit: 'set', maxAllowedUnitPriceNis: 20, maxAllowedTotalPriceNis: 60 },
    },
  ],
  'Tools & Equipment': [
    {
      ...
      priceRule: { unit: 'piece', maxAllowedUnitPriceNis: 45, maxAllowedTotalPriceNis: 120 },
    },
    {
      ...
      priceRule: { unit: 'piece', maxAllowedUnitPriceNis: 130, maxAllowedTotalPriceNis: 320 },
    },
    {
      ...
      priceRule: { unit: 'piece', maxAllowedUnitPriceNis: 35, maxAllowedTotalPriceNis: 90 },
    },
  ],
  Packaging: [
    {
      ...
      priceRule: { unit: 'piece', maxAllowedUnitPriceNis: 5, maxAllowedTotalPriceNis: 30 },
    },
    {
      nameEn: 'Bubble Wrap',
      nameAr: 'لفافة فقاعات',
      ...
      priceRule: { unit: 'roll', maxAllowedUnitPriceNis: 12, maxAllowedTotalPriceNis: 35 },
    },
    {
      nameEn: 'Glass Jars',
      ...
      priceRule: { unit: 'piece', maxAllowedUnitPriceNis: 6, maxAllowedTotalPriceNis: 40 },
    },
  ],
  Metal: [
    {
    ...
    },
    {
      ...
      priceRule: { unit: 'piece', maxAllowedUnitPriceNis: 15, maxAllowedTotalPriceNis: 60 },
    },
  ],
  'Lab & Workshop Supplies': [
    ...
    },
    {
      ...
      priceRule: { unit: 'set', maxAllowedUnitPriceNis: 25, maxAllowedTotalPriceNis: 80 },
    },
    {
      ...
      priceRule: { unit: 'set', maxAllowedUnitPriceNis: 20, maxAllowedTotalPriceNis: 70 },
    },
  ],
  'Construction Leftovers': [
    {
      ...
      priceRule: { unit: 'piece', maxAllowedUnitPriceNis: 8, maxAllowedTotalPriceNis: 50 },
    },
    {
      nameEn: 'PVC Pipes',
      nameAr: 'أنابيب PVC',
      ...
      priceRule: { unit: 'piece', maxAllowedUnitPriceNis: 10, maxAllowedTotalPriceNis: 45 },
    },
  ],
  'Household Reusables': [
    {
      ...
      priceRule: { unit: 'piece', maxAllowedUnitPriceNis: 12, maxAllowedTotalPriceNis: 40 },
    },
    {
      ...
      priceRule: { unit: 'piece', maxAllowedUnitPriceNis: 8, maxAllowedTotalPriceNis: 35 },
    },
  ],
};
