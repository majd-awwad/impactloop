...
describe('TAX-01 material reference matching', () => {
  ...
  test('exact and bilingual alias matrix resolves to canonical types', () => {
    const cases: Array<{ input: string; expected: string }> = [
      ...
      { input: 'حساس رطوبة التربة', expected: 'Soil Moisture Sensor' },
      { input: 'مستشعر رطوبة التربة', expected: 'Soil Moisture Sensor' },
      { input: 'حساس ضوء LDR', expected: 'Light Sensor' },
      { input: 'حساس DHT11', expected: 'DHT11 Sensor' },
