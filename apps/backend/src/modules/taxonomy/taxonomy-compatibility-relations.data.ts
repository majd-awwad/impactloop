...
export const TAXONOMY_COMPATIBILITY_RELATION_SEEDS: readonly TaxonomyCompatibilityRelationSeed[] = [
  ...
  interestRelation('interest:education', 'material-family:lab', 'MATERIAL_FAMILY'),
  ...
  satisfiedByRelation('component:servo-motor', 'material-form:servo-motor'),
  satisfiedByRelation('component:stepper-motor', 'material-form:stepper-motor'),
  satisfiedByRelation('component:raspberry-pi', 'material-form:raspberry-pi'),
  satisfiedByRelation('component:motor-driver', 'material-form:motor-driver'),
