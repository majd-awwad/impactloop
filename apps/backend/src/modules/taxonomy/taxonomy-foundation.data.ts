...
export const TAXONOMY_CONCEPT_SEEDS: readonly TaxonomyConceptSeed[] = [
  ...
  // Recognized learner interest for lab/training personas (required by reviewed interest vocabulary).
  interest('education', 'Lab & Education', 'مختبر وتعليم', [
    alias('lab education', 'EN'),
    alias('lab & education', 'EN'),
    alias('educational', 'EN'),
    alias('learning', 'EN'),
  ]),
  ...
  form('servo-motor', 'Servo Motor', 'محرك سيرفو', ['Servo Motor'], [alias('SG90 servo', 'EN', 'ABBREVIATION'), alias('SG90', 'EN', 'ABBREVIATION'), alias('MG996R', 'EN', 'ABBREVIATION'), alias('سيرفو', 'AR', 'TRANSLATION')]),
  form('stepper-motor', 'Stepper Motor', 'محرك خطوي', ['Stepper Motor'], [alias('NEMA17', 'EN', 'ABBREVIATION'), alias('NEMA 17', 'EN', 'ABBREVIATION'), alias('28BYJ-48', 'EN', 'ABBREVIATION'), alias('ستيبير', 'AR', 'TRANSLATION')]),
  form('raspberry-pi', 'Raspberry Pi', 'راسبيري باي', ['Raspberry Pi'], [alias('RPi', 'EN', 'ABBREVIATION'), alias('راسبيري باي', 'AR', 'TRANSLATION')]),
  form('raspberry-pi-kit', 'Raspberry Pi Kit', 'طقم راسبيري باي', ['Raspberry Pi Kit'], [alias('Raspberry Pi Starter Kit', 'EN'), alias('طقم راسبيري باي', 'AR', 'TRANSLATION')]),
  form('motor-driver', 'Motor Driver', 'درايفر محرك', ['Motor Driver', 'L298N Motor Driver', 'H-Bridge Motor Driver'], [alias('L298N', 'EN', 'ABBREVIATION'), alias('H-Bridge', 'EN', 'ABBREVIATION')]),
  ...
  component('dc-gear-motors', 'DC Gear Motors', 'محركات تيار مستمر مسننة', ['DC gear motors', 'DC motors', 'Gear motors'], ['DC Motor'], [alias('DC gear motor', 'EN')]),
  component('servo-motor', 'Servo Motor', 'محرك سيرفو', ['Servo motor', 'Servo Motor', 'Servo'], ['Servo Motor'], [alias('سيرفو', 'AR', 'TRANSLATION'), alias('SG90', 'EN', 'ABBREVIATION'), alias('MG996R', 'EN', 'ABBREVIATION')]),
  component('stepper-motor', 'Stepper Motor', 'محرك خطوي', ['Stepper motor', 'Stepper Motor'], ['Stepper Motor'], [alias('NEMA17', 'EN', 'ABBREVIATION'), alias('NEMA 17', 'EN', 'ABBREVIATION')]),
  component('raspberry-pi', 'Raspberry Pi', 'راسبيري باي', ['Raspberry Pi'], ['Raspberry Pi'], [alias('RPi', 'EN', 'ABBREVIATION')]),
  component('motor-driver', 'Motor Driver', 'درايفر محرك', ['Motor driver', 'Motor Driver', 'H-Bridge'], ['Motor Driver'], [alias('L298N', 'EN', 'ABBREVIATION')]),
  component('jumper-wires', 'Jumper Wires', 'أسلاك توصيل', ['Jumper wires', 'Dupont wires'], ['Jumper Wires'], [alias('Dupont wires', 'EN')]),
  component('rubber-wheels', 'Rubber Wheels', 'عجلات مطاطية', ['Rubber wheels', 'Wheels'], ['Rubber Wheels']),
  component('breadboard', 'Breadboard', 'لوحة تجارب', ['Breadboard'], ['Breadboard']),
  component('led', 'LED', 'مصباح LED', ['LED', 'LEDs'], ['LED Pack'], [alias('LED diode', 'EN')]),
  component('resistor', 'Resistor', 'مقاومة كهربائية', ['Resistor', 'Resistors'], ['Resistor Pack']),
  component('battery-holder', 'Battery Holder', 'حامل بطارية', ['Battery holder'], ['Battery Holder']),
  component('acrylic-sheets', 'Clear Acrylic Sheets', 'ألواح أكريليك شفافة', ['Clear acrylic sheets', 'Acrylic sheets'], ['Acrylic Sheet']),
  ...
  component('screws-and-nuts', 'Screws and Nuts', 'براغي وصواميل', ['Screws and nuts', 'Screws'], ['Screws and Nuts']),
  component('plywood-panel', 'Plywood Panel', 'لوح خشب رقائقي', ['Plywood panel', 'Plywood sheet'], ['Plywood Sheet']),
  component('mdf-offcut', 'MDF Offcut', 'قطعة MDF متبقية', ['MDF offcut', 'MDF offcuts'], ['MDF Offcuts']),
  component('cardboard-sheets', 'Cardboard Sheets', 'ألواح كرتون', ['Cardboard sheets', 'Cardboard sheet'], ['Cardboard Sheets']),
  component('fabric-scraps', 'Fabric Scraps', 'بقايا أقمشة', ['Fabric scraps', 'Fabric scrap'], ['Fabric Scraps']),
