...
> = {
  MATERIAL_RESERVATION: {
    en: [
      ...
      '3) For delivery, choose or enter the drop-off address. Add an optional note, then submit the reservation request.',
      '4) The supplier reviews the request and may accept it or propose fulfillment details.',
    ...
    ar: [
      ...
      '3) للتوصيل، اختر أو أدخل عنوان التسليم. أضف ملاحظة اختيارية، ثم أرسل طلب الحجز.',
      '4) يراجع المورد الطلب وقد يقبله أو يقترح تفاصيل التنفيذ.',
  ...
  RESERVATION_CANCELLATION: {
    en: [
      'To cancel a reservation request on ImpactLoop:',
      '1) Open My Reservations and select the request.',
      '2) If it is still pending, tap Cancel Request and confirm.',
      '3) If a supplier proposal is awaiting your confirmation, use Cancel on that proposal.',
      'A reservation that is already accepted or completed cannot be cancelled with the normal pending-request action.',
    ].join('\n'),
    ar: [
      'لإلغاء طلب حجز على ImpactLoop:',
      '1) افتح «حجوزاتي» واختر الطلب.',
      '2) إذا كان الطلب ما زال معلّقًا، اضغط «إلغاء الطلب» ثم أكّد.',
      '3) إذا كان اقتراح المورد بانتظار تأكيدك، استخدم «إلغاء» من الاقتراح.',
      'الحجز المقبول أو المكتمل لا يمكن إلغاؤه بإجراء إلغاء الطلب المعلّق المعتاد.',
    ].join('\n'),
  },
  SAVE_PROJECT: {
    en: [
  ...
  MATERIAL_DELIVERY: {
    en: [
      ...
      '3) Choose a saved drop-off address or enter the delivery address and city.',
      ...
      'Pickup means collecting the material from the supplier; delivery sends it to the selected address.',
    ].join('\n'),
    ar: [
      'لطلب توصيل لمادة على ImpactLoop:',
      '1) افتح المادة وابدأ طلب الحجز.',
      '2) اختر التوصيل إذا كانت المادة تدعمه.',
      '3) اختر عنوان تسليم محفوظًا أو أدخل عنوان التوصيل والمدينة.',
      ...
      'الاستلام يعني أخذ المادة من المورد، أما التوصيل فيرسلها إلى العنوان المختار.',
    ].join('\n'),
  },
  RESERVATION_AFTER_SUPPLIER: {
    en: [
