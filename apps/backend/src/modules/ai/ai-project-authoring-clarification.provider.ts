...
import {
  ALL_TOPICS,
  AUTHORING_TOPIC_KEYS,
  type AuthoringProjectDomain,
  type AuthoringReadinessResult,
  type AuthoringTopicContext,
  type AuthoringTopicKey,
  type AuthoringTopicState,
  type AuthoringValidationDiagnostic,
  type AuthoringValidationStage,
  MAX_AUTHORING_CLARIFICATION_QUESTIONS,
  computeAuthoringTopicState,
  detectAuthoringProjectDomain,
  evaluateAuthoringReadiness,
  getLastAuthoringValidationDiagnosticForTests,
  isTopicRelevantForDomain,
